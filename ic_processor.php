    ...
    try
    {
        ...
        else
        {
            ...
            if($cmd == Literals::MULTICHAIN_COMMANDS_CODES['SWM'])
            {
                ...
                echo "<strong><font color='green'>"."Transaction successful.</font> <br/><font color='green'>Transaction ID : </font>"."<a href='".ExplorerParams::$TX_URL_PREFIX.$txId."' target='_new'>$txId</a>"."<br/><font color='green'>Message Sent : </font>".$metadata."<br/><font color='green'>".strval(number_format($units, 2))."</font> Yourcoins transferred"."</strong>";
            }
            else
            {
